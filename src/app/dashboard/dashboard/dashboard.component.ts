...
export class DashboardComponent implements OnInit {
  ...
  private configurarDiasMes() {
    ...
    mesReferencia.setMonth(mesReferencia.getMonth() + 1); //mes seguinte
    mesReferencia.setDate(0); //ultimo dia dos mes

    const quantidade = mesReferencia.getDate(); //quantidade de dias do mes
